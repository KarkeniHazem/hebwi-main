        ...
        <div className="login-html">
          ...
          <div className="login-form">
            <div className="sign-in-htm">
              ...
              <div className="group">
                <input type="submit" onClick={handleLogin} className="button" defaultValue="Sign In" />
              </div>
              <div className="hr" />
            ...
            <div className="sign-up-htm">
              ...
              <div className="group">
                <input type="submit"  onClick={handleRegister} className="button" defaultValue="Sign Up" />
              </div>
              <div className="hr" />
              <div className="foot-lnk">
